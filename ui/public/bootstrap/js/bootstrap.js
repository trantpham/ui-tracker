...
+(function ($) {
  ...
  function allowedAttribute(attr, allowedAttributeList) {
    ...
    const regExp = $(allowedAttributeList).filter((index, value) => value instanceof RegExp);
  ...
  function sanitizeHtml(unsafeHtml, whiteList, sanitizeFn) {
    ...
    const createdDocument = document.implementation.createHTMLDocument('sanitization');
...
+(function ($) {
  ...
  var Affix = function (element, options) {
    ...
    const target = this.options.target === Affix.DEFAULTS.target ? $(this.options.target) : $(document).find(this.options.target);
